...
var createCharacter = exports.createCharacter = function()
{
	...
	createCharacterObj.process = function( )
	{
		var delta = 0.017;
...
var createBattleModel = exports.createBattleModel = function()
{
	...
	createBattleModelObj.process = function()
	{
		createBattleModelObj.character1.process();
		createBattleModelObj.character2.process();
	};
...
var createBattleLogic = exports.createBattleLogic = function( battleModel, logicEvents )
{
	...
	createBattleLogicObj.process = function( )
	{
		...
		createBattleLogicObj.battleModel.process( );
	};
